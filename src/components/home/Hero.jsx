...
import BulgeImageThree from '../effect/BulgeImageThree';
...
const Hero = () => {
  ...
  return (
    <>
      <div ref={main_Ref} className="h-screen w-full overflow-hidden relative">
        <div
          ref={clipRef}
          style={{
        ...
        <div
          className="absolute text-[#18293A] w-full absolute_center  center z-[10] flex-col ">
